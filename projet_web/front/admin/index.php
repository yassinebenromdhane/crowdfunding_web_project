...
<head>
	...
	<!-- Global stylesheets -->
	<link href="global/assets/fonts/inter/inter.css" rel="stylesheet" type="text/css">
	<link href="global/assets/icons/phosphor/styles.min.css" rel="stylesheet" type="text/css">
	<link href="assets/css/ltr/all.min.css" id="stylesheet" rel="stylesheet" type="text/css">
	<!-- /global stylesheets -->

	<!-- Core JS files -->
	<script src="global/assets/demo/demo_configurator.js"></script>
	<script src="global/assets/js/bootstrap/bootstrap.bundle.min.js"></script>
	<!-- /core JS files -->

	<!-- Theme JS files -->
	<script src="global/assets/js/vendor/visualization/d3/d3.min.js"></script>
	<script src="global/assets/js/vendor/visualization/d3/d3_tooltip.js"></script>

	<script src="assets/js/app.js"></script>
	<script src="global/assets/demo/pages/dashboard.js"></script>
	<script src="global/assets/demo/charts/pages/dashboard/streamgraph.js"></script>
	<script src="global/assets/demo/charts/pages/dashboard/sparklines.js"></script>
	<script src="global/assets/demo/charts/pages/dashboard/lines.js"></script>	
	<script src="global/assets/demo/charts/pages/dashboard/areas.js"></script>
	<script src="global/assets/demo/charts/pages/dashboard/donuts.js"></script>
	<script src="global/assets/demo/charts/pages/dashboard/bars.js"></script>
	<script src="global/assets/demo/charts/pages/dashboard/progress.js"></script>
	<script src="global/assets/demo/charts/pages/dashboard/heatmaps.js"></script>
	<script src="global/assets/demo/charts/pages/dashboard/pies.js"></script>
	<script src="global/assets/demo/charts/pages/dashboard/bullets.js"></script>
	<!-- /theme JS files -->
		...
		<div class="container-fluid">
			...
			<div class="navbar-brand flex-1 flex-lg-0">
				<a href="index.html" class="d-inline-flex align-items-center">
					<img src="global/assets/images/logo_icon.svg" alt="">
					<img src="global/assets/images/logo_text_light.svg" class="d-none d-sm-inline-block h-16px ms-3" alt="">
				</a>
			</div>
						...
						<div class="row row-cols-1 row-cols-sm-2 g-0">
							<div class="col">
								<button type="button" class="dropdown-item text-wrap h-100 align-items-start border-end-sm border-bottom p-3">
									<div>
										<img src="global/assets/images/demo/logos/1.svg" class="h-40px mb-2" alt="">
							...
							<div class="col">
								<button type="button" class="dropdown-item text-wrap h-100 align-items-start border-bottom p-3">
									<div>
										<img src="global/assets/images/demo/logos/2.svg" class="h-40px mb-2" alt="">
							...
							<div class="col">
								<button type="button" class="dropdown-item text-wrap h-100 align-items-start border-end-sm border-bottom border-bottom-sm-0 rounded-bottom-start p-3">
									<div>
										<img src="global/assets/images/demo/logos/3.svg" class="h-40px mb-2" alt="">
							...
							<div class="col">
								<button type="button" class="dropdown-item text-wrap h-100 align-items-start rounded-bottom-end p-3">
									<div>
										<img src="global/assets/images/demo/logos/4.svg" class="h-40px mb-2" alt="">
						...
						<div class="dropdown-menu-scrollable pb-2">
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="global/assets/images/demo/users/face10.jpg" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="global/assets/images/demo/users/face3.jpg" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="global/assets/images/demo/users/face24.jpg" class="w-40px h-40px rounded-pill" alt="">
									<span class="status-indicator bg-success"></span>
								</div>
								<div class="flex-1">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="global/assets/images/demo/users/face4.jpg" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="global/assets/images/demo/users/face25.jpg" class="w-40px h-40px rounded-pill" alt="">
						...
						<div class="dropdown-menu w-100" data-color-theme="light">
							...
							<div class="dropdown-menu-scrollable-lg">
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="global/assets/images/demo/users/face3.jpg" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="global/assets/images/demo/users/face24.jpg" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="global/assets/images/brands/adobe.svg" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="global/assets/images/brands/holiday-inn.svg" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="global/assets/images/brands/ing.svg" class="w-32px h-32px rounded-pill" alt="">
									</div>
				...
				<li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
					<a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
						<div class="status-indicator-container">
							<img src="global/assets/images/demo/users/face11.jpg" class="w-32px h-32px rounded-pill" alt="">
							<span class="status-indicator bg-success"></span>
						</div>
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav-group-sub collapse">
								...
								<li class="nav-item"><a href="global/LTR/material/full/index.html" class="nav-link disabled">Material <span class="badge align-self-center ms-auto">Coming soon</span></a></li>
								<li class="nav-item"><a href="global/LTR/clean/full/index.html" class="nav-link disabled">Clean <span class="badge align-self-center ms-auto">Coming soon</span></a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link">
						...
						<li class="nav-item">
							<a href="global/../docs/other_changelog.html" class="nav-link">
							...
							<div class="d-sm-flex align-items-center mb-3 mb-lg-0 ms-lg-3">
								<div class="dropdown w-100 w-sm-auto">
									<a href="#" class="d-flex align-items-center text-body lh-1 dropdown-toggle py-sm-2" data-bs-toggle="dropdown" data-bs-display="static">
										<img src="global/assets/images/brands/tesla.svg" class="w-32px h-32px me-2" alt="">
									...
									<div class="dropdown-menu dropdown-menu-lg-end w-100 w-lg-auto wmin-300 wmin-sm-350 pt-0">
										...
										<a href="#" class="dropdown-item py-2">
											<img src="global/assets/images/brands/debijenkorf.svg" class="w-32px h-32px me-2" alt="">
											<div>
										...
										<a href="#" class="dropdown-item py-2">
											<img src="global/assets/images/brands/klm.svg" class="w-32px h-32px me-2" alt="">
											<div>
										...
										<a href="#" class="dropdown-item py-2">
											<img src="global/assets/images/brands/shell.svg" class="w-32px h-32px me-2" alt="">
											<div>
										...
										<a href="#" class="dropdown-item py-2">
											<img src="global/assets/images/brands/bp.svg" class="w-32px h-32px me-2" alt="">
											<div>
								...
								<div class="d-inline-flex mt-3 mt-sm-0">
									...
									<a href="#" class="status-indicator-container ms-1">
										<img src="global/assets/images/demo/users/face1.jpg" class="w-32px h-32px rounded-pill" alt="">
										<span class="status-indicator bg-success"></span>
									</a>
									<a href="#" class="status-indicator-container ms-1">
										<img src="global/assets/images/demo/users/face3.jpg" class="w-32px h-32px rounded-pill" alt="">
										...
										<tbody>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-block me-3">
															<img src="global/assets/images/brands/facebook.svg" class="rounded-circle" width="36" height="36" alt="">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-block me-3">
															<img src="global/assets/images/brands/youtube.svg" class="rounded-circle" width="36" height="36" alt="">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-block me-3">
															<img src="global/assets/images/brands/spotify.svg" class="rounded-circle" width="36" height="36" alt="">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-block me-3">
															<img src="global/assets/images/brands/twitter.svg" class="rounded-circle" width="36" height="36" alt="">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-block me-3">
															<img src="global/assets/images/brands/bing.svg" class="rounded-circle" width="36" height="36" alt="">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-block me-3">
															<img src="global/assets/images/brands/amazon.svg" class="rounded-circle" width="36" height="36" alt="">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-block me-3">
															<img src="global/assets/images/brands/dribbble.svg" class="rounded-circle" width="36" height="36" alt="">
														</a>
														<div>
										...
										<tbody>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-inline-block me-3">
															<img src="global/assets/images/demo/users/face15.jpg" class="rounded-circle" width="40" height="40" alt="">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-inline-block me-3">
															<img src="global/assets/images/demo/users/face3.jpg" class="rounded-circle" width="40" height="40" alt="">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-inline-block me-3">
															<img src="global/assets/images/demo/users/face8.jpg" class="rounded-circle" width="40" height="40" alt="">
														</a>
														<div>
								...
								<div class="card-body pb-0">
									<div class="row">
										<div class="col-xl-6">
											<div class="d-sm-flex align-items-sm-start mb-3">
												<a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
													<img src="global/assets/images/demo/flat/1.png" class="flex-shrink-0 rounded" height="100" alt="">
											...
											<div class="d-sm-flex align-items-sm-start mb-3">
												<a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
													<img src="global/assets/images/demo/flat/21.png" class="flex-shrink-0 rounded" height="100" alt="">
													<div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
														<i class="ph-play"></i>
													</div>
										...
										<div class="col-xl-6">
											<div class="d-sm-flex align-items-sm-start mb-3">
												<a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
													<img src="global/assets/images/demo/flat/12.png" class="flex-shrink-0 rounded" height="100" alt="">
													<div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
														<i class="ph-play"></i>
													</div>
											...
											<div class="d-sm-flex align-items-sm-start mb-3">
												<a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
													<img src="global/assets/images/demo/flat/18.png" class="flex-shrink-0 rounded" height="100" alt="">
													<div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
														<i class="ph-play"></i>
													</div>
										...
										<tbody>
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-inline-block me-3">
															<img src="global/assets/images/demo/logos/1.svg" alt="" height="36">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-inline-block me-3">
															<img src="global/assets/images/demo/logos/2.svg" alt="" height="36">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-inline-block me-3">
															<img src="global/assets/images/demo/logos/3.svg" alt="" height="36">
														</a>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<a href="#" class="d-inline-block me-3">
															<img src="global/assets/images/demo/logos/4.svg" alt="" height="36">
														</a>
														<div>
								...
								<div class="tab-content card-body">
									<div class="tab-pane active fade show" id="messages-tue">
										<div class="d-flex align-items-start mb-3">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face10.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-success"></span>
										...
										<div class="d-flex align-items-start mb-3">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face3.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-danger"></span>
										...
										<div class="d-flex align-items-start mb-3">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face24.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-danger"></span>
											</div>
										...
										<div class="d-flex align-items-start mb-3">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face4.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-danger"></span>
											</div>
										...
										<div class="d-flex align-items-start">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face25.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-success"></span>
											</div>
									...
									<div class="tab-pane fade" id="messages-mon">
										<div class="d-flex align-items-start mb-3">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face2.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-success"></span>
											</div>
										...
										<div class="d-flex align-items-start mb-3">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face7.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-warning"></span>
											</div>
										...
										<div class="d-flex align-items-start mb-3">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face18.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-warning"></span>
											</div>
										...
										<div class="d-flex align-items-start mb-3">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face14.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-success"></span>
											</div>
										...
										<div class="d-flex align-items-start">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face8.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-success"></span>
											</div>
									...
									<div class="tab-pane fade" id="messages-fri">
										<div class="d-flex align-items-start mb-3">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face15.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-danger"></span>
											</div>
										...
										<div class="d-flex align-items-start mb-3">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face12.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-warning"></span>
											</div>
										...
										<div class="d-flex align-items-start mb-3">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face22.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-danger"></span>
											</div>
										...
										<div class="d-flex align-items-start">
											<div class="status-indicator-container me-3">
												<img src="global/assets/images/demo/users/face17.jpg" class="rounded-circle" width="40" jeight="40" alt="">
												<span class="status-indicator bg-secondary"></span>
											</div>
			...
			<div class="p-3">
				<div class="d-flex align-items-start mb-3">
					<a href="#" class="status-indicator-container me-3">
						<img src="global/assets/images/demo/users/face1.jpg" class="w-40px h-40px rounded-pill" alt="">
						<span class="status-indicator bg-success"></span>
					</a>
					<div class="flex-fill">
					...
					<div class="flex-fill">
						...
						<div class="d-flex my-2">
							<a href="#" class="status-indicator-container me-1">
								<img src="global/assets/images/demo/users/face10.jpg" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-danger"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="global/assets/images/demo/users/face11.jpg" class="w-32px h-32px rounded-pill" alt="">
							...
							<a href="#" class="status-indicator-container me-1">
								<img src="global/assets/images/demo/users/face12.jpg" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="global/assets/images/demo/users/face13.jpg" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
				...
				<div class="d-flex align-items-start mb-3">
					...
					<div class="flex-fill">
						...
						<div class="bg-light rounded p-2 my-2">
							<div class="d-flex align-items-center">
								<div class="me-2">
									<img src="global/assets/images/icons/pdf.svg" width="34" height="34" alt="">
								</div>
								<div class="flex-fill">
									new_contract.pdf
