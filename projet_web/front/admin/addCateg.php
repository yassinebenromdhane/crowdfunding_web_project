                                        ...
                                        <div class="tab-pane fade active show" id="vertical-left-tab1" role="tabpanel">
                                            <form action="#" data-select2-id="45">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" placeholder="Categorie Description">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="text-end">
                                                    <button type="submit" class="btn btn-success">Save <i class="ph-paper-plane-tilt ms-2"></i></button>
                                                </div>
                                            </form>
                                        </div>
