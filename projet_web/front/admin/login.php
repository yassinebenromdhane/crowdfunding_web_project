		...
		<div class="content-wrapper">
			...
			<div class="content-inner">
				...
				<div class="content d-flex justify-content-center align-items-center">
					...
					<!-- Login card -->
					<form class="login-form" method="POST" action="../../controllers/admin/loginAdminController.php">
						<div class="card mb-0">
							<div class="card-body">
								...
								<div class="mb-3">
									...
									<div class="form-control-feedback form-control-feedback-start">
										<input type="email" name="email" class="form-control" required="" placeholder="john@doe.com">
